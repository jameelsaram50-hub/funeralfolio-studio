      ...
      <section className="bg-[#2c1810] text-[#f7f5f2] py-16 px-6 relative overflow-hidden">
        <div className="max-w-4xl mx-auto text-center space-y-5 relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 text-[#d2c2ad] text-xs font-bold uppercase tracking-wider border border-white/10">
            <HelpCircle size={14} className="text-[#967440]" />
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-serif font-medium tracking-tight text-white">
            We Are Here to <span className="italic text-[#967440]">Help</span>
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7 bg-white rounded-[2.5rem] p-8 sm:p-12 shadow-xl border border-gray-200">
            <div className="mb-8">
              <span className="text-[10px] font-bold uppercase tracking-wider text-[#967440]">Send A Request</span>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full bg-[#fdfaf7] border border-gray-200 rounded-xl px-4 py-3 text-sm focus:border-[#967440] outline-none"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    className="w-full bg-[#fdfaf7] border border-gray-200 rounded-xl px-4 py-3 text-sm focus:border-[#967440] outline-none resize-none"
                  />
                </div>
                ...
                >
                  <Send size={14} className="text-[#967440]" />
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-white rounded-[2.5rem] p-8 shadow-lg border border-gray-200 space-y-6">
              <div className="flex items-center gap-2">
                <HelpCircle size={20} className="text-[#967440]" />
              ...
              <div className="pt-4 border-t border-gray-100">
                <Link 
                  to="/blog" 
                  className="text-xs font-bold uppercase tracking-wider text-[#967440] hover:text-[#2c1810] flex items-center gap-1.5 transition-colors"
                >
                  <BookOpen size={14} />
